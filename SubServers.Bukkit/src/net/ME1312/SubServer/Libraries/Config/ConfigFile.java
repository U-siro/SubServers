...
public class ConfigFile 
{
	...
	public List<Sign> getSignList(String path) {return ((List<Sign>)this.config.getList(path));}
 
    @SuppressWarnings("unchecked")
    public List<Sign> getSignList(String path, List<Sign> def) {return  ((List<Sign>)this.config.getList(path, def));}
