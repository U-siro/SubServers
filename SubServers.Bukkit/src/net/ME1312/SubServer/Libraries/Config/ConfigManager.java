...
public class ConfigManager 
{
	...
	public ConfigFile getNewConfig(String fileName, String[] header) 
	{
		...
		ConfigFile config = new ConfigFile(this.getConfigContent(fileName), file, this.getCommentsNum(file), plugin);
		return config;
	}

	public ConfigFile getNewConfig(String fileName) 
	{
