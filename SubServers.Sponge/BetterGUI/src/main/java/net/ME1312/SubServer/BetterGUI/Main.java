...
@Plugin(id="SubServersBetterGUI", name="SubServers BetterGUI", version="1.8.8j", dependencies = "required-after:MinecraftGUIServer;required-after:SubServers")
public class Main {
    ...
    public void onInitialization(GamePostInitializationEvent event) {
        ...
        API.registerListener(new BetterGUI(this, game.getServiceManager().provide(MinecraftGuiService.class).get()), Plugin);
